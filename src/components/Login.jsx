  ...
  return (
    <div className="">
      <div className="bg-[#C4C4C4] w-full h-full pt-5 flex flex-col items-center px-2 py-10 justify-between">
        ...
        <p className="text-[#000] mt-4 mb-4 pt-4">
        ...
        <form className="w-full max-w-lg bg-[#FFF] overflow-hidden rounded-xl px-6 py-2 pt-4">
          <div className="flex flex-wrap mb-4 -mx-3">
            <div className="w-full mb-6">
              <input
                className="block w-full px-9 py-3  leading-tight text-[#555] bg-[#C4C4C4] border  rounded-full appearance-none focus:outline-none focus:[#C4C4C4]"
                id="Email"
                type="text"
                placeholder="Email"
              />
