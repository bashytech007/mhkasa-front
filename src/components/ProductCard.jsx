...
//           {category}
//         </p>
//         <h2 className="text-app-black font-bold text-[16px] pt-1 line-clamp-4 font-FarfetchRegular">
//           {product}
//         </h2>
    ...
    <Link to={`/products/${id}`}>
      ...
      >
        ...
        <div className="px-4 pt-2 pb-4 flex text-sm flex-col flex-grow">
          ...
          <h2 className="text-app-black font-bold text-[16px] pt-1 line-clamp-4 font-FarfetchRegular flex-grow">
            {product}
          </h2>
          <div className="mt-auto">
            ...
            <div className="flex gap-2 w-full mt-2">
              <Button
                variant="rectangle"
                className="md:hidden font-FarfetchRegular block bg-app-black md:w-full px-8 text-center text-app-ash font-medium text-nowrap text-sm @[240px]:bg-app-black"
              >
                Buy Now
              </Button>
              <Button
                variant="rectangle"
                className="hidden md:block font-FarfetchRegular w-full"
              >
                Add To Cart
              </Button>
            </div>
