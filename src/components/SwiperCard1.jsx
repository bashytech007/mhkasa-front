        ...
        <div>
          <div className="w-full title ">
            <div className="flex flex-col gap-4 px-20 pt-10 ">
              <h1 className="text-[#000] lg:text-5xl mt-4 sm:pt-8 sm:text-2xl md:text-3xl font-bold leading-tight md:-mt-2 md:pt-4">
                scented dreams,
              </h1>
              <h1 className="text-[#000] lg:text-5xl sm:-mt-4 sm:pt-3 sm:text-2xl md:text-3xl font-bold leading-tight md:-mt-6 md:pt-2">
                bottled just for
              </h1>
