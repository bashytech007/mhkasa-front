...
export const SwiperCard1 = () => {
  return (
    <div>
      <div className="bg-image md:px-10 px-4 md:pt-1 pt-4 min-h-[400px] md:w-full rounded-3xl md:h-[420px]">
        <div>
          <div className="w-full title ">
            <div className="flex flex-col gap-4 px-4 md:pt-10">
              ...
              <p className="text-sm -mt-2 text-[#323232] sm:text-xs">
                Elevate your senses with our enchating Fragnances
              </p>
            </div>
            <img
              src={dolceimg}
              className="hidden absolute bottom-0 top-0 right-0  sm:bottom-2 sm:right-2 z-[2] w-[400px]"
            />
            <div className="md:px-10 px-4 pt-2 mx-auto">
